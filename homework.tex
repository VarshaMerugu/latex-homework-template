...
\newcommand{\hmwkDueDate}{Sep 22, 2022}
\newcommand{\hmwkClass}{Cryptography and Network Security COMP90043}
\newcommand{\hmwkClassInstructor}{Professor  Udaya Parampalli}
\newcommand{\hmwkAuthorName}{\textbf{Faxing Wang} \and \textbf{11301293}}
...
\title{
    ...
    \normalsize\vspace{0.5in}{Due\ on\ \hmwkDueDate\ at 3:10pm}\\
